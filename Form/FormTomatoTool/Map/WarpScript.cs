...
namespace TomatoTool
{
	...
	{
		private void initializeWarpScript()
		{
			...
			comboBoxWarpScriptList.SelectedIndexChanged += comboBoxWarpScriptList_SelectedIndexChanged;
			comboBoxWarpScriptList.SelectedItem = ((Map)listBoxMap.SelectedItem).WarpScriptList;
		}
		...
		{
			if (((IList)((Map)listBoxMap.SelectedItem).WarpScriptList).Count == 0)
			{
