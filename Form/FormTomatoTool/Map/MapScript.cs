...
namespace TomatoTool
{
	public partial class FormTomatoTool : Form
	{
		private void initializeMapScript()
		{
			...
			comboBoxMapScriptList.SelectedIndexChanged += comboBoxMapScriptList_SelectedIndexChanged;
			comboBoxMapScriptList.SelectedItem = ((Map)listBoxMap.SelectedItem).MapScriptList;
		}
		...
		{
			((Map)listBoxMap.SelectedItem).MapScriptList.MainScript = (Script)comboBoxMapScriptListMainScript.SelectedItem;
		}
		...
		{
			if (((IList)((Map)listBoxMap.SelectedItem).MapScriptList).Count == 0)
			{
